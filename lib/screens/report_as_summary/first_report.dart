...
Future<Uint8List> generateFirstReport(PdfPageFormat pageFormat, List<FirstReportModel> models, String fromdate, String todate) async {
...
class FirstReport {
  ...
  final List<FirstReportModel> products;
  final String date;
...
class FirstReportModel {
  FirstReportModel({
    required this.date,
    required this.invoiceQty,
    required this.invoiceIdRefList,
    required this.total,
  });
  ...
  DateTime date;
  int invoiceQty;
  List<String> invoiceIdRefList;
  int total;

  factory FirstReportModel.fromJson(Map<String, dynamic> json) => FirstReportModel(
        date: DateTime.parse(json["date"]),
        invoiceQty: json["invoice_qty"],
        invoiceIdRefList: List<String>.from(json["invoice_id_ref_list"].map((x) => x)),
        total: json["total"],
      );
}
