...
Future<Uint8List> generateThirdInvoice(PdfPageFormat pageFormat, List<InvoiceModel> models, String id) async {
...
class Invoice {
  ...
  final List<InvoiceModel> products;
  ...
  pw.Widget _contentTable(pw.Context context) {
    const tableHeaders = ['Customer', 'Phone', 'Discount', 'Order Date', 'Product Name', 'Final Price', 'QTY', 'Total'];
